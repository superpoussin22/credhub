...
public class EncryptionKeyRotatorTest {
  ...
  public void beforeEach() {
    ...
    keySet.add(new EncryptionKey(mock(InternalEncryptionService.class), oldUuid, mock(Key.class)));
    keySet.add(new EncryptionKey(mock(InternalEncryptionService.class), activeUuid, mock(Key.class)));
